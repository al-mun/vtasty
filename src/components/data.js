const menu = [
      ...
      `Enjoy!`]},
    {
      ...
      desc: "",
      ingredients: "Rice, lentils, onion, green pepper, carrot, salt, water, pepper, garlic.",
      steps: ['Prepare rice (see recipe on this site)',
      `Soak lentils in water (fully submerged) for 1 hour.`,
      `Chop onion and green pepper into small chunks.`,
      `Peel outer part of carrot, and grate.`,
      `After chopping, put veggies into a pan with a spoonful of oil. Heat on medium.`,
      `Add salt, pepper, and garlic to veggies and mix until they are soft.`,
      `Cook lentils in the water on medium heat for about 10 minutes or until they are soft.`,
      `Once veggies and lentils are cooked, mix together.`,
      `Enjoy!`]},
      {
        id: 6,
        title: 'Rice',
        ...
        time: 20,
        img: 'images/rice.jpg',
        desc: "The most poplular side dish",
        ingredients: "white rice, water, oil, salt",
        steps: ['add 1 cup (or how much desired) of rice to a small pot',
        `Add about 2 cups of water to pot (rule of thumb: measure water by using fingertip. With your fingertip dipped in as far down as the top of the rice, water should be at half an inch level.)`,
        `Add half a teaspoon of salt to rice`,
        `Add half a teaspoon of oil to rice.`,
        `Cover with top.`,
        `Heat on medium or slightly below medium heat.`,
        `Allow to cook for about 5 to 10 minutes, and mix.`, 
        `Repeat mixing after 15 minutes.`, 
        `Taste rice, if chewy, rice is ready. Should not be hard.`,
        `Enjoy!`]},
  ];
  export default menu;
